...
trade_amount_input = "10%"  # 10% of balance, no upper cap
...
def calculate_trade_amount(balance, trade_amount_input):
    if trade_amount_input.endswith("%"):
        ...
        # Apply only a minimum of $1, no upper cap
...
print(f"Using {account_type} account. Initial Balance: ${balance}")
...
try:
    while True:
        ...
        if candle_time != last_candle_time:
            ...
            if len(price_history) >= 15:  # Need at least 15 candles for SNR
